...
*/
  ...
  if ($action==='1') {
      ...
      $wx->tmp_return($access_token, [
        ...
        'url' => user::url().'/story/tran/fetch_openid/'.$c['openid'].'/dict+'.$c['story_id'],
        'data' => [
          'first' => [
              'value' => '投稿成功！感谢贡献词条，点击转发吧',
              'color' => '#808080'
            ],
          'keyword1' => [
  ...
  js::alert('审核成功！');
  jump::to(user::url().'/dict/admin/unactivated/card');
